                    ...
                    <td class="verticleLineBlue"><table  width="100%" border="0" cellpadding="2" cellspacing="6" class="border">
                      <tr>
                        <td colspan="3" valign="top" bgcolor="#E5F3BB"><div align="center">
                            <p>&nbsp;</p>
                          <p><span class="SiteFontNormalCharcolBold"><strong>Thank you for visiting eChefX. </strong></span></p>
                        </div>
                            <hr />
                            <div align="center">
                              <p><span class="SiteFontNormalCharcolBold"><strong>You Should be recieving a copy of your <br>
                                e-Mail submission shortly.</strong></span></p>
                              <p>&nbsp;</p>
                            </div></td>
                      </tr>
                    </table></td>
