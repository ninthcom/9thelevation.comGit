                      ...
                      <td align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td align="center" valign="top"><table width="702" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td><img src="images/1.jpg" width="375" height="119"></td>
                              <td><img src="images/2.jpg" width="375" height="119"></td>
                              </tr>
                            <tr>
                              <td><img src="images/3.jpg" width="375" height="138"></td>
                              <td><img src="images/4.jpg" width="375" height="138"></td>
                              </tr>
                            <tr>
                              <td><img src="images/5.jpg" width="375" height="143"></td>
                              <td><img src="images/6.jpg" width="375" height="143"></td>
                              </tr>
                          </table></td>
                          </tr>
                        <tr>
                          <td height="55" align="center" valign="middle" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol"><strong>eChefX Coolmax Undershirt</strong> , essential to the integration with the jackets, the coolmax &reg; provides superior moisture management and wicking properties, this symbiotic integration maximizes design of the ChefX concept. In white only.</td>
                          </tr>
                        <tr>
                              ...
                              <tr>
                                <td align="left" valign="top"><scxproductlink>
                                    <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                      <input type='hidden' name='part' value='eChefX Coolmax Undershirt'>
                                      <input type='hidden' name='description' value='Ordered - eChefX Coolmax Undershirt'>
<input type='hidden' name='price' value='23.00'>
                                      ...
                                      <input type='hidden' name='include' value='include_max.htm'>
                                      <input type='hidden' name='sameline' value='True'>
                                      <?PHP require('include_max.htm'); ?>
