            ...
            <td><table width="100%" height="430"  cellpadding="0" cellspacing="0" >
              ...
              <tr>
                <td align="center" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="2">
                    <tr>
                      <td height="30" align="center"><p><strong class="section">eChefX - Aprons &amp; Undershirts </strong></p>                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td align="center" valign="middle"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                        <tr>
                          <td rowspan="3"><p>&nbsp;</p>
                              <p>&nbsp;</p></td>
                          <td height="35" align="center" class="HZLine"><span class="section">MAXIMUS</span></td>
                          <td align="center" class="HZLine"><span class="section">CLASSIC BISTRO </span></td>
                          <td align="center" class="HZLine"><span class="section">CLASSIC FOUR-WAY </span><span class="SiteFontNormalFontCharcol"></span></td>
                          <td rowspan="3">&nbsp;</td>
                        </tr>
                        <tr>
                          <td align="center" valign="top"><img src="images/Maximus.jpg" width="225" height="425" border="0" /></td>
                          <td align="center" valign="top"><img src="images/classic-bistro.jpg" width="225" height="425" border="0" /></td>
                          <td align="center" valign="top"><a href="../eChefX-CLASSIC-COLLECTION/index-Joseph.php"></a><img src="images/luca.jpg" width="225" height="425"></td>
                        </tr>
                        <tr>
                          <td align="center" valign="top" class="BoxLine"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="border">
                              <tr>
                                <td height="100" align="center" valign="middle" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol"><strong>MAXIMUS</strong>, our best tuxedo bistro chefs apron with fold over cumberbund, tapered front panel with extra long ties. In 100% Egyptian cotton in White.</td>
                              </tr>
                              ...
                              <tr>
                                <td align="left" valign="top"><scxproductlink>
                                    <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                      <input type='hidden' name='part' value='eChefX - Aprons &amp; Undershirts '>
                                      <input type='hidden' name='description' value='Apron - MAXIMUS - SPECIAL ORDER ITEM'>
                                      ...
                                      <input type='hidden' name='include' value='include_maximus.htm'>
                                      <input type='hidden' name='sameline' value='True'>
                                      <?PHP require('include_maximus.htm'); ?>
                          ...
                          <td align="center" valign="top" class="BoxLine"><strong><a href="../eChefX-CLASSIC-COLLECTION/index-Marques.php"></a></strong>
                            <table width="100%" border="0" cellpadding="0" cellspacing="2">
                              <tr>
                                <td height="100" align="center" valign="middle" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol"><strong>CLASSIC BISTRO</strong>, straight forward chefs bistro apron white in 65/35 poly cotton blend blend, single beson front pocket, extra long ties.</td>
                              </tr>
                              ...
                              <tr>
                                <td align="left" valign="top"><scxproductlink>
                                    <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                      <input type='hidden' name='part' value='eChefX - Aprons &amp; Undershirts  '>
                                      <input type='hidden' name='description' value='Apron - CLASSIC BISTRO'>
                                      ...
                                      <input type='hidden' name='optionname' value='option.gif'>
                                      <input type='hidden' name='includeon' value='True'>
                                      <input type='hidden' name='include' value='include_bistro.htm'>
                                      <input type='hidden' name='sameline' value='True'>
                                      <?PHP require('include_bistro.htm'); ?>
                                      <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                        <tr>
                                          <td width="14%" align="center"><img src='../images/jpg/qty.jpg' alt='Quantity:' name='QtyImg' width="40" height="25" align='absmiddle'></td>
                                          <td width="13%"><input name='Quantity' type='text' class="textfield" value='1' size='3'></td>
                          ...
                          <td align="center" valign="top" class="BoxLine"><strong><a href="../eChefX-CLASSIC-COLLECTION/index-Joseph.php"></a></strong>
                            <table width="100%" border="0" cellpadding="0" cellspacing="2" class="border">
                              <tr>
                                <td height="100" align="center" valign="middle" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol"><strong>CLASSIC FOUR WAY </strong>, standard kitchen apron with extra long ties in white 65/35 poly cotton blend.</td>
                              </tr>
                              ...
                              <tr>
                                <td align="left" valign="top"><scxproductlink>
                                    <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                      <input type='hidden' name='part' value='eChefX - Aprons &amp; Undershirts '>
                                      <input type='hidden' name='description' value='Aprons - CLASSIC FOUR WAY'>
                                      ...
                                      <input type='hidden' name='optionname' value='option.gif'>
                                      <input type='hidden' name='includeon' value='True'>
                                      <input type='hidden' name='include' value='include_4way.htm'>
                                      <input type='hidden' name='sameline' value='True'>
                                      <?PHP require('include_4way.htm'); ?>
                                      <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                        <tr>
                                          <td width="14%" align="center"><img src='../images/jpg/qty.jpg' alt='Quantity:' name='QtyImg' width="40" height="25" align='absmiddle'></td>
                                          <td width="13%"><input name='Quantity' type='text' class="textfield" value='1' size='3'></td>
