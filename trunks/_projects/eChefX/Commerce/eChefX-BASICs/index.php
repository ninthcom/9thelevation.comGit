...
<html>
<head>
<title>eChefX-Aprons - Basics </title>
            ...
            <td><table width="100%" height="430"  cellpadding="0" cellspacing="0" >
              ...
              <tr>
                <td height="401" align="center" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="2">
                  <tr>
                    <td height="30" align="center"><p><strong class="section">eChefX - Basics </strong></p></td>
                  </tr>
                  <tr>
                    <td align="center"><font color="#666666">(eChefX Basic section is being populated with new items late '07)</font></td>
                  </tr>
                  <tr>
                    <td align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td align="center" valign="top"><table width="702" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="285" align="left" valign="top"><img src="images/1.jpg" width="285" height="402"></td>
                                <td width="417" align="center" valign="middle" background="images/2.jpg"><span class="section"><strong>LUCIANNO</strong></span><span class="SiteFontNormalFontCharcol"><strong>,<br>
                                </strong>quality and value incorporated in these jackets, Rolled portriat collar Double breast styling , 10 knot buttons front chest pocket and sleeve pocket. Avalible in&nbsp;&nbsp;65/35 poly cotton blends, in White.</span></td>
                              </tr>
                              
                          </table></td>
                        </tr>
                        <tr>
                          <td height="55" align="center" valign="middle" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol">&nbsp;</td>
                        </tr>
                        <tr>
                          <td align="center" valign="top"><table width="300" border="0" cellpadding="0" cellspacing="2" class="BoxLine">
                              <tr>
                                <td></td>
                              </tr>
                              <tr>
                                <td align="left" valign="top"><scxproductlink>
                                    <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                      <input type='hidden' name='part' value='eChefX - Basics '>
                                      <input type='hidden' name='description' value='Ordered - eChefX - Basics - LUCIANNO'>
                                      ...
                                      <input type='hidden' name='include' value='include_luciano.htm'>
                                      <input type='hidden' name='sameline' value='True'>
                                      <?PHP require('include_luciano.htm'); ?>
