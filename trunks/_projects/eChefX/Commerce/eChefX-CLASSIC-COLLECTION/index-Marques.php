                                ...
                                <td><table width="100%" border="0" cellpadding="2" cellspacing="2" class="BoxLine">
                                  <tr>
                                    <td width="100%"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="border">
                                        ...
                                        <tr>
                                          <td height="100" align="center" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol"><strong>MARQUES</strong>, classic design features rolled portrait collar, 12 hand sewn all cotton 
                                            buttons,modified venting at underarm, available<br />
in 60/40 cotton rich blend, White.</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><scxproductlink>
                                              <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                                ...
                                                <input type='hidden' name='description' value='Mens Coat - MARQUES'>
                                                ...
                                                <input type='hidden' name='include' value='include_marques.htm'>
                                                <input type='hidden' name='sameline' value='True'>
                                                <?PHP require('include_marques.htm'); ?>
                          ...
                          <td width="286"><img src="images/Maques.jpg" width="284" height="570"></td>
                        </tr>
