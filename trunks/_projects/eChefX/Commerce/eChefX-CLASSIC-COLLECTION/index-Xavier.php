                      ...
                      <td align="center"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                        <tr>
                          <td align="center"><table width="80%" border="0" cellspacing="1" cellpadding="0">
                              <tr>
                                <td height="30" align="center"><strong class="section">eChefX Classic Collection</strong></td>
                              </tr>
                              <tr>
                                <td><table width="100%" border="0" cellpadding="2" cellspacing="2" class="BoxLine">
                                  <tr>
                                    <td width="100%"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="border">
                                        ...
                                        <tr>
                                          <td height="100" align="center" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol"><strong>XAVIER</strong>, traditional styling with 12 hand sewn all cotton buttons,double breast 
                                            front chest pocket,sleeve pocket,modified venting at underarm, available in
                                            White in 60/40 Cotton rich blend</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><scxproductlink>
                                              <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                                <input type='hidden' name='part' value='eChefX Classic Collection'>
                                                <input type='hidden' name='description' value='Mens Coat - Xavier'>
                                                ...
                                                <input type='hidden' name='include' value='include_xavier.htm'>
                                                <input type='hidden' name='sameline' value='True'>
                                                <?PHP require('include_xavier.htm'); ?>
                          ...
                          <td width="286"><img src="images/Xavier.jpg" width="284" height="570"></td>
                        </tr>
