                                ...
                                <td><table width="100%" border="0" cellpadding="2" cellspacing="2" class="BoxLine">
                                  <tr>
                                    <td width="100%"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="border">
                                        ...
                                        <tr>
                                          <td height="100" align="center" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol"><strong>AMBER</strong>, the classic 12 hand sewn all cotton double breast jacket, front besom 
                                            chest pocket and sleeve pocket, modified underarm venting, 
avalable in 60/40 cotton rich blend also.</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><scxproductlink>
                                              <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                                ...
                                                <input type='hidden' name='description' value='Womens Coat - AMBER'>
                                                ...
                                                <input type='hidden' name='include' value='include_amber.htm'>
                                                <input type='hidden' name='sameline' value='True'>
                                                <?PHP require('include_amber.htm'); ?>
                          ...
                          <td width="286"><img src="images/Amber.jpg" width="284" height="570"></td>
                        </tr>
