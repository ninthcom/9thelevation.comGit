                    ...
                    <tr>
                      <td align="center"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                        <tr>
                                ...
                                <td><table width="100%" border="0" cellpadding="2" cellspacing="2" class="BoxLine">
                                  <tr>
                                    <td width="100%"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="border">
                                        ...
                                        <tr>
                                          <td height="100" align="center" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol"><strong>NAPA</strong>, Asymetrical style incorporates clean and simplistic lines<br>
                                            This style includes the &quot;eChefX cool chef system&quot;<br>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><scxproductlink>
                                              <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                                ...
                                                <input type='hidden' name='description' value='Mens Coat - NAPA'>
                                                <input type='hidden' name='price' value='86.00'>
                                                ...
                                                <input type='hidden' name='include' value='include_napa.htm'>
                                                <input type='hidden' name='sameline' value='True'>
                                                <?PHP require('include_napa.htm'); ?>
                          ...
                          <td width="286"><img src="images/Napa.jpg" width="287" height="573"></td>
                        </tr>
