                    ...
                    <tr>
                      <td align="center"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                        <tr>
                                ...
                                <td><table width="100%" border="0" cellpadding="2" cellspacing="2" class="BoxLine">
                                  <tr>
                                    <td width="100%"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="border">
                                        ...
                                        <tr>
                                          <td height="100" align="center" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol"><strong>SPIRIT</strong>,The passion of the womens line continues<br>
                                            the flattering lines of the vest front,slimming from the classic <br>
                                            double breast to a single button front, hand sewn buttons this jacket features 
                                            a full pass through venting in the back and the venting system. Extremely stylish 
                                            shown in White 100% Egyptian Cotton</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><scxproductlink>
                                              <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                                ...
                                                <input type='hidden' name='description' value='Womens Coat - SPIRIT'>
                                                ...
                                                <input type='hidden' name='include' value='include_spirit.htm'>
                                                <input type='hidden' name='sameline' value='True'>
                                                <?PHP require('include_spirit.htm'); ?>
                              ...
                              <tr>
                                <td align="center"><table width="64%" border="0" cellspacing="1" cellpadding="0">
                                  <tr>
                                    ...
                                    <td height="20" nowrap><strong><a href="#" onclick="MM_openBrWindow('../embroibery/sizing.html','','width=600,height=650')">Sizing Charts</a></strong> </td>
                                  </tr>
                                  <tr>
                                    <td align="center"><img src="../images/jpg/embriobery-options.jpg" width="26" height="16"></td>
                                    <td height="20" nowrap><a href="../embroibery/index.php"><strong>Embroidery Options</strong></a>  </td>
                                  </tr>
                                  <tr>
                                    <td width="14%" align="center"><img src="../images/PDFsm.gif" width="26" height="16"></td>
                                    <td width="86%" height="20" nowrap><strong><a href="../contacts/index.php">Download the New eChefX Catalog </a></strong></td>
                                  </tr>
                                </table></td>
                              </tr>
                              <tr>
                          ...
                          <td width="286"><img src="images/Spirt.jpg" width="286" height="573"></td>
                        </tr>
