                    ...
                    <tr>
                      <td align="center"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                        <tr>
                                ...
                                <td><table width="100%" border="0" cellpadding="2" cellspacing="2" class="BoxLine">
                                  <tr>
                                    <td width="100%"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="border">
                                        ...
                                        <tr>
                                          <td height="100" align="center" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol"><strong>MARQUIS</strong>, Our first design in the Lady X line, classic<br>
                                            styling with superior workmanship,12 hand sewn finished<br>
                                            cotton buttons,features &quot;echefx cool chef system,<br>
                                            shown in White Egyptian Cotton</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><scxproductlink>
                                              <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                                ...
                                                <input type='hidden' name='description' value='Womens Coat - MARQUIS'>
                                                ...
                                                <input type='hidden' name='include' value='include_marquis.htm'>
                                                <input type='hidden' name='sameline' value='True'>
                                                <?PHP require('include_marquis.htm'); ?>
                          ...
                          <td width="286"><img src="images/Marquis.jpg" width="286" height="570"></td>
                        </tr>
