                    ...
                    <tr>
                      <td align="center"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                        <tr>
                                ...
                                <td><table width="100%" border="0" cellpadding="2" cellspacing="2" class="BoxLine">
                                  <tr>
                                    <td width="100%"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="border">
                                        ...
                                        <tr>
                                          <td height="100" align="center" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol"><strong>INSIGNIA</strong>, contemporary design meets function and<br>
                                            comfort, easily accessable concealed front snap closure<br>
                                            clean lines, chest pocket, and sleeve pockets, and the<br>
                                            eChefX cool chef system, available in White Egyptian Cotton</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><scxproductlink>
                                              <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                                ...
                                                <input type='hidden' name='description' value='Mens Coat - INSIGNIA'>
                                                ...
                                                <input type='hidden' name='include' value='include_insignia.htm'>
                                                <input type='hidden' name='sameline' value='True'>
                                                <?PHP require('include_insignia.htm'); ?>
                          ...
                          <td width="286"><img src="images/Insignia.jpg" width="287" height="573"></td>
                        </tr>
