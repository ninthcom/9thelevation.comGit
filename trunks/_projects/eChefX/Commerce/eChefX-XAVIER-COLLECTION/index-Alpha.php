                    ...
                    <tr>
                      <td align="center"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                        <tr>
                                ...
                                <td><table width="100%" border="0" cellpadding="2" cellspacing="2" class="BoxLine">
                                  <tr>
                                    <td width="100%"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="border">
                                        ...
                                        <tr>
                                          <td height="100" align="center" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol"><strong>ALPHA</strong>, This classic design reflects the traditional lines<br>
                                            of the chef jacket while providing superior workmanship, <br>
                                            features the &quot;eChefX cool Chef system&quot; available in <br>
                                            White 100% Egyptian Cotton </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><scxproductlink>
                                              <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                                ...
                                                <input type='hidden' name='description' value='Mens Coat - ALPHA'>
                                                ...
                                                <input type='hidden' name='include' value='include_alpha.htm'>
                                                <input type='hidden' name='sameline' value='True'>
                                                <?PHP require('include_alpha.htm'); ?>
                          ...
                          <td width="286"><img src="images/Alpha.jpg" width="284" height="572"></td>
                        </tr>
