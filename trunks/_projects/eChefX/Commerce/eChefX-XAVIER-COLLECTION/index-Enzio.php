                                ...
                                <td><table width="100%" border="0" cellpadding="2" cellspacing="2" class="BoxLine">
                                  <tr>
                                    <td width="100%"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="border">
                                        ...
                                        <tr>
                                          <td height="100" align="center" bgcolor="#FBFFD6" class="SiteFontNormalFontCharcol"><strong>ENZIO</strong>, Classic styling with portrait collar, 12 hand sewn<br>
  cotton buttons, featuring the &quot;eChefX cool chef system,<br>
                                            available in White 100% Egyptian Cotton, or Black<br>
                                        ...
                                        <tr>
                                          <td align="left" valign="top"><scxproductlink>
                                              <form action='../sc-bin/shop1.php' method='POST' name='scform'>
                                                ...
                                                <input type='hidden' name='description' value='Mens Coat - ENZIO'>
                                                <input type='hidden' name='price' value='92.00'>
                                                ...
                                                <input type='hidden' name='include' value='include_enzio.htm'>
                                                <input type='hidden' name='sameline' value='True'>
                                                <?PHP require('include_enzio.htm'); ?>
                          ...
                          <td width="286"><img src="images/Enzio.jpg" width="286" height="572"></td>
                        </tr>
